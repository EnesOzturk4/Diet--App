...
{
    public partial class StatusUsersForm : Form
    {
        UserViewModel _user;
        ...
        int id;
        public StatusUsersForm(UserViewModel user)
        {
        ...
        private void InitMealDietRecord()
        {
            ...
            List<MealDietRecordViewModel> records = manager.Search(x => x.UserId == _user.Id).ToList();
        ...
        private void dataGridViewMealRecord_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
